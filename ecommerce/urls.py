...
urlpatterns = [
    ...
    path('send-return', views.send_return_view,name='send-return'),
    path('view-return', views.view_return_view,name='view-return'),
    ...
    path('payment-online', views.payment_online_view,name='payment-online'),
